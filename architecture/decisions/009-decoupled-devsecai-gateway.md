...
* **Cost & Compute Optimization:** By blocking malicious payloads at the Gateway layer, we prevent the costly multi-agent swarm from executing and burning API tokens on unauthorized compute.